...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0fe92a31f31078b274b9d79613af7f47) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mirage-clock-lwt", None);
                           FindlibPackage ("mirage-time-lwt", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mirage-protocols", None);
                           FindlibPackage ("mirage-protocols-lwt", None);
                           FindlibPackage ("mirage-random", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mirage-protocols", None);
                           FindlibPackage ("mirage-protocols-lwt", None);
                           FindlibPackage ("mirage-stack-lwt", None);
                           FindlibPackage ("mirage-net-lwt", None);
                           FindlibPackage ("mirage-time", None);
                           FindlibPackage ("mirage-random", None);
                           FindlibPackage ("mirage-device", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "]=\025D\239\226\167\129\n\252\210I\209\214\139\185";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
